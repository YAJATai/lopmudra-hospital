...
function Hero() {
  return (
    <section className="relative min-h-[70vh] flex items-center bg-gradient-to-b from-navy to-navy/90">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-32">
        ...
        >
          <Sparkles className="h-3 w-3 text-emerald" /> About Lopmudra
        </motion.div>
        <TextReveal
          as="h1"
        ...
        >
          For nearly two decades, Lopmudra has stood for quality healthcare that
          feels personal, honest, and always within reach.
        </motion.p>
      </div>
    </section>
  );
      ...
      <GlassPanel className="overflow-hidden rounded-[2rem]">
        <div className="grid lg:grid-cols-2">
          <div className="p-10 sm:p-14 lg:p-16">
            <div className="mb-3 text-[11px] font-semibold uppercase tracking-[0.25em] text-navy/60">
              Our Story
            </div>
            <TextReveal
              as="h2"
              className="font-display text-3xl sm:text-4xl font-medium leading-[1.05]"
            >
            ...
            >
              <p>
                Lopmudra Hospital began in 2008 as a modest clinic with two
                consulting rooms and a single delivery suite. The founding vision
                was straightforward: create a space where patients felt heard,
                where doctors had time to listen, and where clinical decisions
                were made based on need.
              </p>
              <p>
                Today, we've grown into a full-fledged multispeciality hospital
                with a modern OT, neonatal ICU, in-house diagnostics, and over 25
                specialists. But what hasn't changed is the culture: unhurried
                consultations, transparent billing, and a steadfast refusal to
                compromise on patient care.
              </p>
              <p>
                We've served over 50,000 patients and are consistently rated 4.6
                stars — not because we chase ratings, but because we treat every
                patient the way we'd want our own family treated.
              </p>
            </motion.div>
          </div>
          <div className="flex items-center justify-center p-10 sm:p-14 lg:p-16 bg-soft">
            <div className="grid grid-cols-2 gap-4 w-full max-w-sm">
              {[
                ...
                <div key={s.label} className="text-center rounded-2xl p-5 bg-surface border border-border">
                  <div className="font-display text-3xl font-medium text-charcoal">{s.value}</div>
        ...
        <div className="grid gap-px overflow-hidden rounded-3xl bg-white/10">
          {[
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: i * 0.1 }}
              className="flex flex-col items-center gap-2 px-6 py-12 text-center text-white bg-navy"
            >
...
function CTA() {
  return (
    <section className="py-32">
      <div className="mx-auto max-w-6xl px-6">
        <GlassPanel className="relative overflow-hidden rounded-[2rem] p-12 sm:p-16 text-center">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_60%_at_50%_0%,oklch(0.25_0.04_260/0.04),transparent_70%)]" />
          <div className="relative">
            <Heart className="mx-auto h-8 w-8 mb-6 text-navy/40" />
            <TextReveal as="h2" className="font-display text-4xl sm:text-5xl font-medium leading-[1.05]">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
              <Link
                to="/appointments"
                className="relative overflow-hidden rounded-full px-7 py-3.5 text-sm font-medium text-white bg-navy hover:bg-navy/90 transition-colors"
              >
              ...
              <Link
                to="/contact"
                className="flex items-center gap-2 rounded-full border border-border px-7 py-3.5 text-sm font-medium text-charcoal hover:bg-soft transition-colors"
              >
                Get in Touch
              </Link>
            </div>
